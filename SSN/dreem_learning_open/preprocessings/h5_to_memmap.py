...
from dreem_learning_open.preprocessings.epoch_features_processing import epoch_features
from dreem_learning_open.preprocessings.signal_processing import signal_processings
from dreem_learning_open.utils.utils import get_group_description_from_record_description
...
def h5_to_memmaps(records, memmap_directory, memmap_description, parallel=False, force=False,
